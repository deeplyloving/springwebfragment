...
//        if (NNTecher.configuration.getProperty("memcached", "disabled").equals("enabled")) {
        if (false) {	
//        	if (SystemUtils.loadSystemProperties().getProperty("memcached", "disabled").equals("enabled")) {	
            try {
